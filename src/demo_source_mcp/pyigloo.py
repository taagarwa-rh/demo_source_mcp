# ruff: noqa
# Modified from https://github.com/xkahn/pyigloo
...
class igloo:
    ...
    def search_contentdetailed(
        self,
        objectSearchType=None,
        facetFields=None,
        labels=None,
        authorIds=None,
        applications=None,
        ...
        """
        url = "{0}{1}v{2}/communities/{3}/search/contentDetailed".format(
            self.endpoint, self.IGLOO_API_ROOT_V2, self.version, self.communitykey
        )
        headers = {b"Accept": "application/json"}
        params = {
    ...
    def get_all_search_contentdetailed(
        self,
        objectSearchType=None,
        facetFields=None,
        labels=None,
        ...
        """
        items = self.search_contentdetailed(
            offset=page * limit,
            limit=limit,
            objectSearchType=objectSearchType,
            facetFields=facetFields,
